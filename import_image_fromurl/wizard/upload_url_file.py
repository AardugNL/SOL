        ...
        if record_list:
            ...
            for line in record_list:
                ...
                if map_field == 'partner_id':
                    ...
                    part = partner.search([('name', '=', content[0]), ('supplier', '=', True)])
                    if part:
        ...
        for row_number in range(sheet.nrows):
            if row_number <= 0:
                ...
                if map_field == 'partner_id':
                    ...
                    part = partner.search([('name', '=', line[0]), ('supplier', '=', True)])
                    if part:
                        part.write({'image_url': line[1]})
        return True
        ...
        if record_list:
            ...
            for line in record_list:
                ...
                if map_field == 'partner_id':
                    ...
                    part = partner.search([('name', '=', content[0]), ('customer', '=', True)])
                    if part:
                        part.write({'image_url': content[3]})
        return True
        ...
        for row_number in range(sheet.nrows):
            if row_number <= 0:
                ...
                if map_field == 'partner_id':
                    ...
                    part = partner.search([('name', '=', line[0]), ('customer', '=', True)])
                    if part:
                        part.write({'image_url': line[1]})
        return True
